...
export class LadaboutusComponent implements OnInit, OnDestroy  {
  ...
  ngOnInit() {
    ...
    this.slidesL.push({
      image: "https://vitthallad.github.io/ladfragrances" + this.all_b_c
    });
    this.slidesL.push({
      image:  "https://vitthallad.github.io/ladfragrances" + this.all_b
    });
    this.slidesL.push({
      image:  "https://vitthallad.github.io/ladfragrances" + this.haripriya_b_c
    });
    this.slidesL.push({
      image:  "https://vitthallad.github.io/ladfragrances" + this.deccan_b_c
    });
    this.slidesL.push({
      image: "https://vitthallad.github.io/ladfragrances" + this.rajashri_b_c
    });
    this.slidesL.push({
      image:  "https://vitthallad.github.io/ladfragrances" + this.deccan_s_c
    });
    this.slidesL.push({
      image:  "https://vitthallad.github.io/ladfragrances" + this.rajashree_s_c
    });
